...
public class WizQuizQueAnsAdapter extends RecyclerView.Adapter<WizQuizQueAnsAdapter.ViewHolder> {

    private List<BinderItem> listItems;
    private Context context;

    public WizQuizQueAnsAdapter(List<BinderItem> listItems, Context context) {
