...
public class LabListDialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements LabTabConstants {
    ...
    private class LabListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        RelativeLayout labListLinearLayout;
        ...
        LabListViewHolder(View view, LabListAdapterClickListener labListAdapterClickListener) {
            ...
            labListLinearLayout = (RelativeLayout) view.findViewById(R.id.lab_list_root_layout);
    ...
    public LabListDialogAdapter(ArrayList<Object> objectArrayList, Context context, LabListAdapterClickListener labListAdapterClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case VIEW_ITEM_DATA:
                View dataView = inflater.inflate(R.layout.item_lab_list_dialog, viewGroup, false);
                viewHolder = new LabListViewHolder(dataView, labListAdapterClickListener);
                break;
            default:
                View defaultView = inflater.inflate(R.layout.item_lab_list_dialog, viewGroup, false);
