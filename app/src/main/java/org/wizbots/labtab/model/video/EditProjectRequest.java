...
public class EditProjectRequest implements Parcelable {
    ...
    public EditProjectRequest(String id, String mentor_id, int status, String path, String title, String category, String mentor_name, String lab_sku, String lab_level, ArrayList<String> knowledge_nuggets, String description, ArrayList<Student> project_creators, String notes_to_the_family, String program_id) {
        this.id = id;
    ...
    protected EditProjectRequest(Parcel in) {
    ...
    public static final Creator<EditProjectRequest> CREATOR = new Creator<EditProjectRequest>() {
        @Override
        public EditProjectRequest createFromParcel(Parcel source) {
            return new EditProjectRequest(source);
        }

        @Override
        public EditProjectRequest[] newArray(int size) {
            return new EditProjectRequest[size];
        }
    };
}
