...
public class CreateProjectResponse {
    ...
    public CreateProjectResponse(String category, String sku, String description, String title, String notes, boolean is_transcoding, VideoResponse video, String[] components, String[] creators, String id) {
