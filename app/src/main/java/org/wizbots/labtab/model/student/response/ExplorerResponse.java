...
public class ExplorerResponse {
    ...
    public ExplorerResponse(String lab_time, ArrayList<String> imagineering, ArrayList<String> mechanisms, ArrayList<String> programming, ArrayList<String> structures, ArrayList<ProjectResponse> projects) {
